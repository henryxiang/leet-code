4. Median of Two Sorted Arrays | Algorithms | Hard | Array, Binary Search, Divide and Conquer
...
Thanks to [@Quentin.chen](https://leetcode.com/Quentin.chen) for pointing out that: $$i  0$$ and $$i > 0 \implies j < n$$. Because:


>$$m \leq n,\  i  \frac{m+n+1}{2} - m \geq \frac{2m+1}{2} - m \geq 0$$
>
